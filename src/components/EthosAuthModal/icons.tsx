...
export const FarcasterIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg viewBox="0 0 1000 1000" fill="none" className={className}>
    ...
    <path d="M128.889 253.333L182.222 351.111H257.778V253.333H128.889Z" fill="currentColor"/>
    <path d="M742.222 253.333V351.111H817.778L871.111 253.333H742.222Z" fill="currentColor"/>
  </svg>
);
